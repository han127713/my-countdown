...
workout_time = st.number_input(" 健身練了幾分鐘？", min_value=0, step=5, key="gym_time")
...
pushups = st.number_input(" 伏地挺身做了幾下？", min_value=0, step=1, key="pushup_count")
