...
if st.button("🎲 抽取今日運勢"):
    fortunes = [
        ...
        {"status": "凶", "msg": "督導路過看了你一眼，皮繃緊一點。", "icon": "⚡"},
        {"status": "大凶", "msg": "今天的公差...媽逼勒，你自己保重吧。", "icon": "🤮"},
...
trash_talk = ["😒 才做幾下？你是進去度假的嗎？", "🤮 這種體能，你之後會變成恰恰？", "👎 太廢了喔！給我繼續動起來不要偷懶"]
good_talk = ["🔥 帥喔！這肌肉我可以！", "🥰 這樣才可以穿綠色壞壞喔！", "💪 完美！期待讓你看到藍色衣服！"]
