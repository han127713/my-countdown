...
💖 **今日老婆的話：** 陳新加油！今天是倒數第 35 天了，雖然在裡面很辛苦，但撐過去就是妳的了！我在外面乖乖等妳回來喔～ ❤️
""")

st.divider()

# --- 2. 自動倒數邏輯 ---
# 設定退伍日期為 6 月 16 日，這樣 5/12 算出來就會是剩下 35 天
...
st.divider()
st.caption(f"📅 今天的日期是：{today} (系統每天會自動幫妳扣天數)")
